...
const Sobre = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-petrol-dark via-petrol to-petrol-dark text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-72 h-72 bg-accent rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-solar-yellow-light rounded-full blur-3xl" />
        </div>
